...
class IncidentReportPolicy
{
    ...
    {
        return $user->can('force_delete_incident::report');
    }
    ...
    {
        return $user->can('force_delete_any_incident::report');
    }
    ...
    {
        return $user->can('restore_incident::report');
    }
    ...
    {
        return $user->can('restore_any_incident::report');
    }
    ...
    {
        return $user->can('replicate_incident::report');
    }
    ...
    {
        return $user->can('reorder_incident::report');
    }
}
